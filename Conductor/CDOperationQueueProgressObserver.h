...
@property (assign) NSInteger startingOperationCount;

@property (copy) CDOperationQueueProgressObserverProgressBlock progressBlock;

@property (copy) CDOperationQueueProgressObserverCompletionBlock completionBlock;
